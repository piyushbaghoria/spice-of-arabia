    ...
    return {
            ...
            if (document.getElementById("siqiframe")) S.className = S.className.replace(/(?:^|\s)siq_showload(?!\S)/, "");
                ...
                !window._IS_DEV && function() {
                    ...
                    if (iscdnenabled && !$ZSIQChat.isPreview()) {
                        var t = $zohosq.nonce,
                            i = {};
                        i[SIQ_FLOAT] = "/salesiq/styles/floatbuttonpostload_Pa0WG0fin4SjrnBZjHin5vP3GQC_Nv9XqLM6KV_i-I5DsoInRo88Uwa8oyhuF8bR_.css", i[SIQ_BUTTON] = "/salesiq/styles/buttonthemepostload_26386ojVxwJ5TKyuHZgrQRLTyfiMMqSWI2LBPfIUM212DJsdXh9KRChFaaRHf3NU_.css", i[SIQ_PERSONALIZE] = "/salesiq/styles/personalizethemepostload_sLci-XVkHeGTpJncovl4VnwEuWaeUXDvpRK1R-OHriuPdFUR-4GrZBgko_ZeNum3_.css";
                        var a = e.widgetobj,
        ...
        getFiles: function() {
            ...
            if (iscdnenabled && (i.cssstaticfile = "/salesiq/styles/embedtheme" + t.theme + "_" + cssjslist[i.cssstaticfile] + "_.css", i.jsstaticfile = "/salesiq/js/siqchatwindow" + t.theme + "_" + cssjslist[i.jsstaticfile] + "_.js"), $ZSIQChatWindow.isNewHeader()) {
                ...
                i.cssstaticfile = t.isRtlLang ? "/salesiq/styles/embedrtl_LVRLoAJr2ZwIYG4R9Pp3FHfNQ7OfO48vDk733fnr6Fi7BS6IH-63JcuQJNGWusBl_.css" : "/salesiq/styles/newembedtheme_RQYtYGQdIU72U13mGx94UvCdXmr-Asp8MEoJFAGNsgA60cz2tyudo9E1bVGE5d9C_.css", i.jsstaticfile = g ? "/salesiq/js/siqnewchatwindow1_YCkCxLQ2mTQx-z20UnSDyApyfsiETaGHdQpE1lYh_-Jcs8aDPjl47rOpGaR-QBpD_.js" : "/salesiq/js/siqnewchatwindow_UPIa5w2cyL1MU1eUb1rmN5RtFM0WXTnA53hPf50qBsrmdE5gcLmzRWY-6H6rXPZY_.js"
            }
